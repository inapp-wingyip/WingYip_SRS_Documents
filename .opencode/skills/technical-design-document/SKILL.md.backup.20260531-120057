...
2. Once approved, invoke the `generate-docx` skill to produce the `.docx` file with:
...
3. Save to `design-docs/NN-<short-name>.docx` (e.g., `01-payment-service-integration.docx`). If `design-docs/` does not exist, ask the user where to save.
